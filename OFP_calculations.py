...
# Load VOC_conc
VOC_conc = pd.read_excel(r"C:\mydata\Optimal solution\ICDN\OFP\Bronx_conc.xls", index_col="Date")
...
# Load Residuals
Residuals = pd.read_excel(r"C:\mydata\Optimal solution\ICDN\OFP\Residuals_unscaled.xlsx", index_col="Date")
...
# Load MIR
MIR = pd.read_excel(r"C:\mydata\Optimal solution\ICDN\OFP\MIR.xlsx", index_col="Species")
...
OFP = VOC_unnorm.mul(MIR.reindex(VOC_unnorm.columns)['MIR'], axis=1)
...
OFP_total.to_excel(r"C:\mydata\Optimal solution\ICDN\OFP\OFP_total.xlsx")
...
file_path = r"C:\mydata\Optimal solution\ICDN\OFP\OFP_total.xlsx"
...
plt.ylabel('Ozone Formation Potential (ppbv)')
plt.title('Ozone Formation Potential by Factor in Bronx')
...
plt.savefig("OFP_barplot.png", bbox_inches='tight', transparent=True)
...
plt.xlabel('')
plt.ylabel('Ozone Formation Potential (ppbv)')
plt.title('Seasonal Ozone Formation Potential by Factor in Bronx', fontsize=10)
...
# Save the figure with a transparent background
plt.savefig("OFP_stacked_barplot.png", bbox_inches='tight', transparent=True)
...
# Set labels and title
plt.xlabel('')
plt.ylabel('Normalized Ozone Formation Potential')
plt.title('Normalized Seasonal Ozone Formation Potential by Factor in Bronx', fontsize=10)
...
# Save the figure with a transparent background
plt.savefig("OFP_normalized_barplot.png", bbox_inches='tight', transparent=True, dpi=300)
